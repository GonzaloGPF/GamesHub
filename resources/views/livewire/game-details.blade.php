        ...
        <div class="lg:ml-12 lg:mr-64">
            ...
            <div class="flex flex-wrap items-center mt-8">
                <div class="flex items-center">
                    <div id="memberRating" class="bg-gray-800 rounded-full w-16 h-16 text-xs relative">
                        @push('scripts')
                ...
                <div class="flex items-center ml-12">
                    <div id="criticRating" class="bg-gray-800 rounded-full w-16 h-16 text-xs relative">
                        @push('scripts')
                            @include('partials.rating', [
                                'slug' => 'criticRating',
                ...
                <div class="flex items-center mt-4 lg:mt-0 lg:ml-12 space-x-4">
                    @if($game['social']['official'])

                    @endif
                    @if($game['social']['instagram'])
                        <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                            <a href="{{ $game['social']['instagram']['url'] ?? null }}"
                    ...
                    @if($game['social']['facebook'])
                        <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                            <a href="{{ $game['social']['facebook']['url'] ?? null }}"
                               class="hover:text-gray-400"
                               target="_blank">
                                <svg role="img"
                                     viewBox="0 0 24 24"
                    ...
                    @if($game['social']['twitter'])
                        <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                            <a href="{{ $game['social']['twitter']['url'] ?? null }}"
                               class="hover:text-gray-400"
                               target="_blank">
                                <svg role="img"
                                     viewBox="0 0 24 24"
                ...
                @if (isset($game['trailer']))
                    <div class="mt-12">
                        <a href="{{ $game['trailer'] }}"
                           target="_blank">
                            <button class="inline-flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
